...
class Database {
   ...
   * @param {number} [timeout] - How long to wait before giving up in milliseconds (default is 45 seconds)
  ...
  /**
   * Unregister a previously registered reactive query (keep the number of registered queries to a minimum!)
